...
(function() {
  ...
  var require_seed = __commonJS({
    "lib/seed.json": function(exports, module) {
      module.exports = [
        "54.95.108.148",
        "34.227.204.75",
        "13.112.58.64",
  ...
  var require_nodes = __commonJS({
    "lib/nodes.js": function(exports) {
      ...
      var seed_json_1 = __importDefault(require_seed());
      var Nodes = function() {
        function Nodes2() {
          this.nodeIndex = -1;
        ...
        Nodes2.prototype.init = function(seed) {
          return __awaiter(this, void 0, void 0, function() {
            var payload, _i, _a, member;
              ...
              switch (_b.label) {
                case 0:
                  ...
                  if (typeof seed === "undefined") {
                    seed = seed_json_1.default;
                  }
                  return [4, this.loadSeed(seed)];
                case 1:
                  payload = _b.sent();
                  if (!payload) {
                  ...
                  this.topology = payload.CurrentTopology;
        ...
        Nodes2.prototype.loadSeed = function(seed) {
          return __awaiter(this, void 0, void 0, function() {
            var _i, seed_1, s, url, response, data, e_1;
              ...
              switch (_a.label) {
                ...
                case 1:
                  if (!(_i < seed_1.length))
                    return [3, 7];
                  s = seed_1[_i];
                  url = "http://".concat(s, "/services/management-service/status");
                  _a.label = 2;
                case 2:
                  _a.trys.push([2, 5, , 6]);
                  return [4, fetch(url)];
                ...
                case 4:
                  data = _a.sent();
                  if (data.Payload)
                    return [2, data.Payload];
                  return [3, 6];
                case 5:
                  e_1 = _a.sent();
                  console.error("exception in fetch loadSeed ".concat(s, ":"), e_1);
                  return [3, 6];
                case 6:
                  _i++;
                  return [3, 1];
